...
오늘은 그동안 스프링 프레임워크를 사용하며 Service Layer의 역할에 대해서 오해하고 있었던 부분에 대해 포스팅을 하고자 합니다. 이번 포스팅에서 주로 이야기 하고싶은 주제는 크게 3가지 입니다. 첫번째 Layered Architecture, 두번째 Service Layer의 역할 그리고 마지막 세번째 객체지향적 개발에 대해서 포스팅을 이어 나가도록 하겠습니다.
